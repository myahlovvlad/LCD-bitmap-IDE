...
| `deleteScreen` | screen; linked FSM states are preserved and detached | Canonical engineering state | Yes | Yes | Yes | Phase 1B.1 command | `screen.delete` | Screens + FSM links | Full validation | Command history | Migrated in 1B.1 | Adapter + E2E tests |
